...
export default function Page({ params }: Props) {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKENDURL}/api/v1/digital_download/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const handleSubmit = async (e: any) => {
    ...
    setLoading(true);
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_BACKENDURL}/api/v1/digital_download/${data.product.id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const props: UploadProps = {
    ...
    multiple: true,
    action:
      `${process.env.NEXT_PUBLIC_BACKENDURL}/api/v1/file/upload`,
    onChange(info) {
  ...
  const handleDelete = async (e: any) => {
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_BACKENDURL}/api/v1/file/delete`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
